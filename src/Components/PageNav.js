        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-1 flex items-center justify-between sm:items-stretch sm:justify-between">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="text-white hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium" onClick={() => setIsOpen(false)}>
            ...
            <div className={"absolute top-16 right-0 bg-gray-800 " + (isOpen ? "flex w-screen z-50" : "hidden")} id="mobile-menu">
              <div className="px-2 pt-2 pb-3 space-y-3">
                <Link to="/favoriter" className="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-bold" onClick={() => setIsOpen(false)}>
                  Favoriter
                </Link>
                <Link
                  to="/narliggande"
                ...
                <Link to="/om" className="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-bold"  onClick={() => setIsOpen(false)}>
                  Om sidan
                </Link>
              </div>
            </div>
