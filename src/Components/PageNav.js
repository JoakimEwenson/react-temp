      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto" defaultActiveKey="/">
          ...
          <LinkContainer to="/narliggande">
            <NavLink><i class="fas fa-location-arrow mr-2"></i>Närliggande</NavLink>
          </LinkContainer>
          <LinkContainer to="/platslista">
            <NavLink><i class="fas fa-bars mr-2"></i>Alla mätpunkter</NavLink>
          </LinkContainer>
          <LinkContainer to="/om">
            <NavLink><i class="fas fa-question-circle mr-2"></i>Om tjänsten</NavLink>
          </LinkContainer>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
